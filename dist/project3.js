...
//Literal type
function calculation2(n1, n2, resultType // not string. compared to enum style, of course it could be used, but if there is a few values I have to name specific type and the kind is only string or number, Literal typeed | string typed delcaration would be work efficiently.
) {
    let result;
    if ((typeof n1 === "number" && typeof n2 === "number") ||
...
let whatLearn = { section: 2, subject: "what?" };
let inputTest1;
let inputTest2;
